...
// ── ITEM TYPE MAP ─────────────────────────────────────────────────
const ITEM_TYPE_MAP = {
	"Body Wash(es)": "Hygiene",
	"Conditioner(s)": "Hygiene",
	"Deodorant(s)": "Hygiene",
	...
	"All-Purpose Cleaner(s)": "Household",
	"Bleach(es)": "Household",
	"Broom(s)": "Household",
	"Dish Detergent(s)": "Household",
	"Laundry Detergent(s)": "Household",
	"Mop(s)": "Household",
	"Paper Towel - Roll(s)": "Household",
	"Sponge(s)": "Household",
	"Toilet Tissue - Roll(s)": "Household",
	"Trash Bag - Box(es)": "Household",
};
